...
void cdc_rndis_init(void)
{
    ...
    usbd_add_interface(0, usbd_rndis_init_intf(0, &intf0, CDC_OUT_EP, CDC_IN_EP, CDC_INT_EP, mac));
    usbd_add_interface(0, usbd_rndis_init_intf(0, &intf1, CDC_OUT_EP, CDC_IN_EP, CDC_INT_EP, mac));
    usbd_initialize(0);
}
