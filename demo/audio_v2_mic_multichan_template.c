...
void audio_v2_init(uint8_t busid)
{
    ...
    usbd_add_interface(busid, usbd_audio_init_intf(busid, &intf0[busid], 0x0200, audio_entity_table, 2));
    usbd_add_interface(busid, usbd_audio_init_intf(busid, &intf1[busid], 0x0200, audio_entity_table, 2));
