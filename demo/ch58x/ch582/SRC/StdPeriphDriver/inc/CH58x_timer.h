...
//计数功能
void TMR0_EXTSingleCounterInit( CapModeTypeDef cap );				/* 外部信号边沿计数初始化 */
...
//计数功能
void TMR1_EXTSingleCounterInit( CapModeTypeDef cap );				/* 外部信号边沿计数初始化 */
...
//计数功能
void TMR2_EXTSingleCounterInit( CapModeTypeDef cap );				/* 外部信号边沿计数初始化 */
...
//计数功能
void TMR3_EXTSingleCounterInit( CapModeTypeDef cap );				/* 外部信号边沿计数初始化 */
