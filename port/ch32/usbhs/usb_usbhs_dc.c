...
int usbd_ep_open(uint8_t busid, const struct usb_endpoint_descriptor *ep)
{
    ...
    if (USB_EP_DIR_IS_IN(ep->bEndpointAddress)) {
        ...
        USBHSD->UEP_TX_ISO = USB_GET_ENDPOINT_TYPE(ep->bmAttributes) == USB_ENDPOINT_TYPE_ISOCHRONOUS ?
        ...
        USBHSD->UEP_RX_ISO = USB_GET_ENDPOINT_TYPE(ep->bmAttributes) == USB_ENDPOINT_TYPE_ISOCHRONOUS ?
