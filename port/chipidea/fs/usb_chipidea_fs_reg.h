 ...
 */
#ifndef __USB_CHIPIDEA_FS_REG_H__
#define __USB_CHIPIDEA_FS_REG_H__
 ...
 */
typedef union {
    chipidea_fs_bd_t table[16][2][2]; /*!< [EndPoint] [Direction] [Odd_Even]. */
    uint8_t buffer[512];              /*!< buffer. */
} chipidea_fs_bd_table_t;
