                ...
                if ((ep_intr & 0x1U) != 0U) {
                    ...
                    if ((epint & USB_OTG_DIEPINT_XFRC) == USB_OTG_DIEPINT_XFRC) {
                        if (ep_idx == 0) {
                            ...
                            usb_dcache_invalidate((uintptr_t)g_dwc2_udc[busid].in_ep[ep_idx].xfer_buf, USB_ALIGN_UP(g_dwc2_udc[busid].in_ep[ep_idx].actual_xfer_len, CONFIG_USB_ALIGN_SIZE));
